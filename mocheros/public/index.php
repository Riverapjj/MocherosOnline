...
<div class="slider">
    <ul class="slides">
        ...
        <li>
            <img src="../resources/img/mochilas-8.jpg"> <!-- random image -->
            <div class="caption center-align">
                <h3 class="indigo-text text-darken-4 flow-text">¡Todos nuestros accesorios son elaborados para ti!</h3>
                <h5 class="orange-text text-darken-3 flow-text">Ponemos empeño y dedicación en cada producto que realizamos</h5>
                <a href="../views/public/accesorios.php" class="orange-text text-darken-3 flow-text">Haz click aquí para ver nuestros accesorios</a>
            </div>
        </li>
    </ul>
