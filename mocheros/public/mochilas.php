...
<body>
    ...
    <div id="modal4" class="modal">
        ...
        <div class="modal-content">
            <h4 class="orange-text">Mochila bordada con parches</h4>
            <div class="row">
                ...
                <div class="col s12 m6">
                    ...
                    <p><b> Precio Regular:</b>$45.00<br></p>
                    <p><b>Descripción:</b></p>
                    <p>Mochila para uso escolar decorada con parches bordados</p>
                </div>
            </div>
        </div>
        <div class="modal-footer">
                ...
                <div class="col s12 m6 l3">
                    <div class="card">
                        ...
                        <div class="card-action">
                            <a class="modal-trigger orange-text" href="#modal4">Ver más</a>
                        </div>
                    </div>
                </div>
                <div class="col s12 m6 l3">
