    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col l4 offset-l2 s12">
                ...
                <p class="grey-text text-lighten-4">kidszone@gmail.com</p>
            </div>
        </div>
    </div>
    <div class="footer-copyright">
        <div class="container">
            © 2018 Derechos reservados a KIDSZONE S.A. de C.V.    
        </div>
        <div class="container">
            ...
            <a class="grey-text text-lighten-4 right" href="https://www.youtube.com"><i class="material-icons">play_circle_filled</i> Youtube&nbsp;&nbsp;&nbsp;</a>
