...
<div id="modal4" class="modal">
    ...
    <div class="modal-content">
        <h4 class="orange-text">Lonchera roja</h4>
        <div class="row">
            <div class="col s12 m6">
                <img class="responsive-img" src="../../resources/img/lonchera1.jpg">
            </div>
            <div class="col s12 m6">
                <p><b>Código Del Producto:</b> 87352214<br></p>
                <p><b> Precio Regular:</b>$32.99<br></p>
                <p><b>Descripción:</b></p>
                <p>Lonchera de nylon roja, ideal para el uso en la escuela, colegio, universidad y el trabajo</p>
            </div>
        </div>
    </div>
    <div class="modal-footer">
